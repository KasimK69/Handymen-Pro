...
const Hero = () => {
  ...
  return (
    <section className="relative bg-gradient-to-r from-brand-blue to-brand-blue/80 pt-32 pb-20 overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            >
              <Button 
                size="lg" 
                className="bg-brand-red hover:bg-brand-red/90 text-white shadow-lg" 
                asChild
              >
            ...
            >
              <a 
                ...
                className="flex items-center hover:text-white transition-colors mr-6"
              >
