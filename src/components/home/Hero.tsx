...
const Hero = () => {
  ...
  return <section className="relative bg-gradient-to-r from-brand-blue to-brand-blue/80 pt-32 pb-20 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            <motion.h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6" custom={1} initial="hidden" animate="visible" variants={fadeIn}>
              Professional AC Services in Rawalpindi & Islamabad
            </motion.h1>
            <motion.p className="text-lg md:text-xl opacity-90 mb-8 leading-relaxed max-w-xl" custom={2} initial="hidden" animate="visible" variants={fadeIn}>
            ...
            {/* Features */}
            <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8" custom={3} initial="hidden" animate="visible" variants={fadeIn}>
            ...
            {/* CTAs */}
            <motion.div className="flex flex-col sm:flex-row gap-4" custom={4} initial="hidden" animate="visible" variants={fadeIn}>
            ...
            {/* Contact Info */}
            <motion.div className="mt-8 flex flex-wrap items-center text-white/80 gap-y-2" custom={5} initial="hidden" animate="visible" variants={fadeIn}>
          ...
          delay: 0.3
            ...
            <div className="relative rounded-lg overflow-hidden shadow-2xl">
              <img alt="Professional AC service in Rawalpindi" className="w-full h-auto rounded-lg object-cover" loading="eager" src="/lovable-uploads/05b08b97-a88a-4b4f-81f6-8e0c4fa82a0f.jpg" />
              
              {/* Stats Overlay */}
              <motion.div className="absolute -bottom-6 -right-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
